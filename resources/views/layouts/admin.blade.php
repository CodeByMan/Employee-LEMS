...
<head>
    ...
    <title>@yield('title', 'SkillTrack LEMS') | Dashboard</title>
 ...
 <style>
      ...
      /* Minimal responsive hardening: keep existing UI, only fix layout behavior */
      .sidebar {
        width: 200px;
        max-width: 85vw;
        overflow-y: auto;
  ...
  <nav class="sidebar d-flex flex-column p-3" id="sidebar">
    <div class="text-center">
      ...
      <img
        ...
        alt="SkillTrack LEMS Logo"
        class="system-logo mx-auto d-block mb-3"
        style="max-height: 80px;"
      >

      <!-- System Name -->
      <h4 class="system-name text-white mb-4">SkillTrack LEMS</h4>
    </div>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <!-- <li class="nav-item">
        <a href="{{ route('users.index') }}"
          ...
          data-tooltip="SkillTrack LEMS">
          <i class="bi bi-envelope-fill me-2"></i><span> SkillTrack LEMS</span>
        </a>
      </li> -->
      <li class="nav-item">
        <a href="#"
...
<div class="modal fade" id="logoutModal" tabindex="-1" aria-labelledby="logoutModalLabel" aria-hidden="true">
  ...
  <div class="content-wrapper">
              ...
              <div class="modal-body">
                ...
                <div class="text-center">
                  ...
                  <p class="small mb-0">
                    ...
                    <a href="https://github.com/CodeByMan" target="_blank" rel="noopener">https://github.com/CodeByMan</a>
                  </p>
                </div>
              </div>
    ...
    <footer class="text-center py-3 mt-auto bg-light" style="font-size: 0.85rem;">
      <div class="container">
        <span class="text-muted">© {{ date('Y') }} SkillTrack LEMS. All rights reserved.</span>
      </div>
    </footer>
