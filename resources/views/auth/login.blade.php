    ...
    <div class="relative">
        ...
        <form method="POST" action="{{ route('login') }}" class="mt-5">
           ...
           <!-- Remember Me and Forgot Password -->
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mt-4 p-2">
            ...
            <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-between sm:items-center mt-4 mb-4">
                <!-- Back Button -->
