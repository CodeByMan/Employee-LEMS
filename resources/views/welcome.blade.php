...
<head>
    ...
    <title>SkillTrack LEMS | Learner & Employee Management System</title>
...
<body class="min-h-screen flex items-center justify-center text-white antialiased">
    <div class="max-w-2xl text-center px-6 py-12 glass rounded-3xl shadow-lg">
        <div class="flex justify-center mb-6">
            <img src="{{ asset('images/logo.svg') }}" alt="Logo" class="h-20 w-20 logo-animation">
            <!-- <img src="https://laravel.com/img/logomark.min.svg" alt="Laravel Logo" class="h-20 w-20 logo-animation"> -->
        </div>
        <h1 class="text-3xl font-semibold mb-2">Welcome to SkillTrack LEMS</h1>
        <p class="text-lg mb-6">Learner & Employee Management System</p>
