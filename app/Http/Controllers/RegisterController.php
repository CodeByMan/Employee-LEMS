...
class RegisterController extends Controller
{
    ...
    public function registerByAdmin(Request $request)
    {
        ...
        Mail::html(<<<HTML
            ...
            <p>You are receiving this email because a registration has been initiated for your account in the <strong>SkillTrack Learner & Employee Management System</strong>.</p>
            ...
            <br>
            <p>Thank you,<br>SkillTrack LEMS Administrator</p>
        HTML
        , function ($message) use ($request) {
            $message->to($request->email)
                    ->subject('Your One-Time Password (OTP) for SkillTrack LEMS Registration');
        });
